...
return {
  ...
  keys = {
    ...
    -- {"i", "<Tab>", _G.MUtils.tab_complete, {silent = true, noremap = true, expr = true}},
    -- {"i", "<S-Tab>", _G.MUtils.back_tab_complete, {silent = true, noremap = true, expr = true}},
    -- -- -- Make <CR> to accept selected completion item or notify coc.nvim to format
    -- -- -- <C-g>u breaks current undo, please make your own choice
    -- {"i", "<CR>", _G.MUtils.enter, {silent = true, noremap = true, expr = true}},
    --
    ...
    --
    -- -- Show documentation and scroll it
    -- {"n", "K", _G.MUtils.help, {silent = true}},
    ...
    -- {"n", "<space>a", "<Plug>(coc-codeaction-cursor)", {silent = true, nowait = true}},
    -- {"n", "<space>s", "<Plug>(coc-codeaction-refactor)", {silent = true, nowait = true}},
    -- {"n", "<space>x", "<Plug>(coc-codeaction-line)", {silent = true, nowait = true}},
    -- {"n", "<space>g", "<Plug>(coc-codelens-action)", {silent = true, nowait = true}},
    -- {"n", "<space>f", "<Plug>(coc-fix-current)", {silent = true, nowait = true}},
    -- {'n', "<space>r", "<Plug>(coc-codeaction-refactor-selected", {silent = true, nowait = true}},
    -- {'x', "<space>r", "<Plug>(coc-codeaction-refactor-selected", {silent = true, nowait = true}},
    -- {"n", "<space>e", ":<C-u>CocList extensions<cr>", {silent = true, nowait = true}},
    -- {"n", "<space>c", ":<C-u>CocList commands<cr>", {silent = true, nowait = true}},
    -- {"n", "<space>o", ":<C-u>CocList outline<cr>", {silent = true, nowait = true}},
    -- {"n", "<space>q", ":<C-u>CocList<cr>", {silent = true, nowait = true}},
    -- {"n", "<space>d", _G.MUtils.diagnostic, {silent = true, nowait = true}},
  },
  build = "npm ci",
  config = function()
    vim.g.coc_global_extensions = { 'coc-json', 'coc-go', 'coc-yaml', 'coc-sh', 'coc-markdownlint' }
